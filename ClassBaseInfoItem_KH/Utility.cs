...
namespace ClassBaseInfoItem_KH
{
    public class Utility
    {
        ...
        /// <returns></returns>
        public static string SendData(string action,string ClassName, string ClassID, string OldTeacherName, string NewTeacherName,string Reason, string EDoc)
        {
            ...
            {                
                {
                    ...
                    Content.SetElementValue("OldTeacherName", OldTeacherName);
                    Content.SetElementValue("NewTeacherName", NewTeacherName);
