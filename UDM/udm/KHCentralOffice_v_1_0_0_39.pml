<Project Name="KHCentralOffice">
	<Property Name="UDT">
		...
		<Release Version="1.0.0.36" URL="udm/UDT_1_0_0_36.tcmd" />
		<Release Version="1.0.0.37" URL="udm/UDT_1_0_0_37.tcmd" />
		<Release Version="1.0.0.38" URL="udm/UDT_1_0_0_38.tcmd" />
		<Release Version="1.0.0.39" URL="udm/UDT_1_0_0_39.tcmd"></Release>
	</Property>
	<Property Name="UDS">
...
where tag.prefix='聯課活動' and tag.name='社團' and @@Condition  @@Order]]>
	...
	<Resources>
		<Resource Name="mainSQL">
			<![CDATA[
				SELECT id, name, english_name, birthdate, id_number, ref_class_id, 
                            mailing_address, permanent_address, contact_phone, gender, 
                            nationality, overseas_compatriot_from , seat_no, 
                            father_name, father_nationality, mother_name, mother_nationality, custodian_name, custodian_nationality, father_living, mother_living,
                            sems_history 
