	...
	<Package Name="_">
		...
		<Service Enabled="true" Name="GetOpening">
			<Definition Type="dbhelper">
				...
				<FieldList Name="FieldList" Source="Field">
					<Field Alias="EndDate" Mandatory="True" OutputType="DateTime" Source="EndDate" Target="end_date" />
					<Field Alias="StartDate" Mandatory="True" OutputType="DateTime" Source="StartDate" Target="start_date" />
				</FieldList>
