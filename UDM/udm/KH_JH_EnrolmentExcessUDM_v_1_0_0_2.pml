<Project Name="KH_JH_EnrolmentExcessUDM">
	<Property Name="UDT">
		...
		<Release Version="1.0.0.1" URL="udm/UDT_1_0_0_1.tcmd" />
		<Release Version="1.0.0.2" URL="udm/UDT_1_0_0_2.tcmd"></Release>
	</Property>
	<Property Name="UDS">
	...
	<Package Name="_">
		...
		<Service Enabled="true" Name="GetNow">
			<Definition Type="dbhelper">
				<Action>Select</Action>
				<SQLTemplate><![CDATA[SELECT @@FieldList]]></SQLTemplate>
				<ResponseRecordElement />
				<FieldList Name="FieldList" Source="">
					<Field Alias="DateTime" Mandatory="True" OutputConverter="DateTime" Source="DateTime" Target="now()" />
				</FieldList>
			</Definition>
		</Service>
