<Project Name="CounselSystem_dep">
	<Property Name="UDT">
		<Release Version="1.0.0.7" URL="udm/UDT_1_0_0_7.tcmd" />
		<Release Version="1.0.0.8" URL="udm/UDT_1_0_0_8.tcmd"></Release>
	</Property>
	<Property Name="UDS">
	...
	<Package Name="_">
		...
		<Service Enabled="true" Name="DelRelative">
			<Definition Type="dbhelper">
				<Action>Delete</Action>
				<SQLTemplate><![CDATA[DELETE FROM $ischool.counsel.relative WHERE @@Condition]]></SQLTemplate>
...
WHERE @@Condition @@Order</SQLTemplate>
		...
		<Service Enabled="true" Name="GetQuestionsData">
			<Definition Type="dbhelper">
				...
				<Conditions Name="Condition" Required="False" Source="Condition">
					<Condition Required="False" Source="GroupName" Target="group_name" />
					<Condition Required="False" Source="Name" Target="Name" />
				</Conditions>
				<Orders Name="Order" Source="Order">
		...
		<Service Enabled="true" Name="GetRelative">
			<Definition Type="dbhelper">
				...
				<FieldList Name="FieldList" Source="Field">
					...
					<Field Alias="Phone" Mandatory="True" Source="Phone" Target="phone" />
				</FieldList>
				<Conditions Name="Condition" Required="False" Source="Condition">
					<Condition Required="True" Source="StudentID" SourceType="Variable" Target="ref_student_id" />
				</Conditions>
		...
		<Service Enabled="true" Name="GetSchoolAllGrade">
			<Definition Type="dbhelper">
				<Action>Select</Action>
				<SQLTemplate><![CDATA[SELECT @@FieldList FROM class WHERE status = '1' and grade_year is not null Group By grade_year Order by grade_year]]></SQLTemplate>
				<ResponseRecordElement>Response/Grade</ResponseRecordElement>
				<FieldList Name="FieldList" Source="Field">
		...
		<Service Enabled="true" Name="InsertRelative">
			<Definition Type="dbhelper">
				<Action>Insert</Action>
				<SQLTemplate><![CDATA[INSERT INTO $ischool.counsel.relative @@FieldList]]></SQLTemplate>
				<RequestRecordElement>Relative</RequestRecordElement>
				<FieldList Name="FieldList" Source="">
	...
	<Package Name="_">
		<Service Enabled="true" Name="AddInterviewRecord">
			<Definition Type="DBHelper">
				<Action>Insert</Action>
				<SQLTemplate><![CDATA[INSERT INTO $counsel.interview_record @@FieldList]]></SQLTemplate>
				...
				<Preprocesses>
					<Preprocess InvalidMessage="501" Name="VaildVisible" Type="Validate"><![CDATA[
                ...
                where c.status=1 and c.ref_teacher_id='@@TeacherID'
					...
					<Preprocess Name="Authorname" Type="variable"><![CDATA[
		...
		<Service Enabled="true" Name="DelRelative">
			<Definition Type="dbhelper">
				...
				<InternalVariable>
					<Variable Key="TeacherID" Name="TeacherID" Source="UserInfo" />
					<Variable Key="Relative/StudentID" Name="StudentID" Source="Request" />
				</InternalVariable>
				<Preprocesses>
					<Preprocess InvalidMessage="501" Name="VaildVisible" Type="Validate"><![CDATA[
                            select s.id as sid, s.student_number, s.name, s.seat_no, s.status
...
WHERE name='系統設定'</SQLTemplate>
		...
		<Service Enabled="true" Name="GetInterviewRecord">
            ...
            ORDER BY ir.interview_date DESC, ir.interview_time]]></SQLTemplate>
				...
				<FieldList Name="FieldList" Source="">
					...
					<Field Alias="InterviewDate" Mandatory="True" OutputConverter="Date" Source="InterviewDate" Target="interview_date" />
		...
		<Service Enabled="true" Name="GetQuestionsData">
			<Definition Type="dbhelper">
				...
				<FieldList Name="FieldList" Source="Field">
					...
					<Field Alias="QuestionType" Mandatory="True" Source="QuestionType" Target="question_type" />
					<Field Alias="Items" Mandatory="True" OutputType="xml" Source="Items" Target="items" />
					<Field Alias="CanTeacherEdit" Mandatory="True" Source="CanTeacherEdit" Target="(case can_teacher_edit when 't' then '是' else '否' end)" />
				</FieldList>
				<Conditions Name="Condition" Required="False" Source="Condition" />
				<Orders Name="Order" Source="Order">
					<Order Source="GroupName" Target="group_name" />
		...
		<Service Enabled="true" Name="InsertRelative">
			<Definition Type="dbhelper">
				...
				<RequestRecordElement>Relative</RequestRecordElement>
				<FieldList Name="FieldList" Source="">
					<Field Source="Uid" Target="uid" />
					<Field Source="LastUpdate" Target="last_update" />
					<Field Source="BirthYear" Target="birth_year" />
					<Field Source="EduDegree" Target="edu_degree" />
					<Field Source="Institute" Target="institute" />
					<Field Source="IsAlive" Target="is_alive" />
